...
class EXosPluginEnvCreds(BaseModel, extra=Extra.forbid):
    """
...
class EXosPluginEnvConfig(BaseModel, extra=Extra.forbid):
    read: EXosPluginEnvCreds
    admin: Optional[EXosPluginEnvCreds] = None


class EXosPluginConfig(BaseModel, extra=Extra.forbid):
    """define the schema for the plugin configuration"""

    env: EXosPluginEnvConfig
    timeout: int = 60
