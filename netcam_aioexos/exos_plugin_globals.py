...
class EXosGlobals:
    ...
    basic_auth: httpx.BasicAuth
        The authorization value that will be used for read-only access the EXOS
        devices via API. This username-password auth combination is prepared
    ...
    config: Optional[EXosPluginConfig] = None
